      ...
      <div className="grid md:grid-cols-3 gap-4 mt-8">
        <div className="md:col-span-2 space-y-4">
          {cartItems?.map((item, index) => (
            <div className="flex gap-4 bg-white px-4 py-6 rounded-md shadow-[0_2px_12px_-3px_rgba(6,81,237,0.3)]" key={index}>
              <div className="flex gap-4">
                ...
                <div className="flex flex-col gap-4">
                  <div>
                    ...
                    <p className="text-sm font-semibold text-gray-500 mt-2 flex items-center gap-2">Price: <span className="inline-block w-5 h-5 rounded-md">${item?.price}</span></p>
                  </div>
                  ...
                  <div className="mt-auto flex items-center gap-3">
                    ...
                    <span className='font-bold text-sm leading-[18px]'>Quantity : {item?.quantity}</span>
                    {/* <button type="button"
                      className="flex items-center justify-center w-5 h-5 bg-gray-400 outline-none rounded-full">
              ...
              <div className="ml-auto flex flex-col">
                <div className="flex items-start gap-4 justify-end">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-4 cursor-pointer fill-gray-400 inline-block" viewBox="0 0 24 24" onClick={() => deleteCartItem(item.id)}>
                    <path d="M19 7a1 1 0 0 0-1 1v11.191A1.92 1.92 0 0 1 15.99 21H8.01A1.92 1.92 0 0 1 6 19.191V8a1 1 0 0 0-2 0v11.191A3.918 3.918 0 0 0 8.01 23h7.98A3.918 3.918 0 0 0 20 19.191V8a1 1 0 0 0-1-1Zm1-3h-4V2a1 1 0 0 0-1-1H9a1 1 0 0 0-1 1v2H4a1 1 0 0 0 0 2h16a1 1 0 0 0 0-2ZM10 4V3h4v1Z" data-original="#000000"></path>
                    <path d="M11 17v-7a1 1 0 0 0-2 0v7a1 1 0 0 0 2 0Zm4 0v-7a1 1 0 0 0-2 0v7a1 1 0 0 0 2 0Z" data-original="#000000"></path>
                  </svg>
                </div>
                <h3 className="text-base font-bold text-gray-800 mt-auto">${(item?.quantity * item?.price).toFixed(2)}</h3>
              </div>
            </div>
          ))}
        ...
        <div className="bg-white rounded-md px-4 py-6 h-max shadow-[0_2px_12px_-3px_rgba(6,81,237,0.3)]">
          <ul className="text-gray-800 space-y-4">
            <li className="flex flex-wrap gap-4 text-sm">Subtotal <span className="ml-auto font-bold">
            ...
            <li className="flex flex-wrap gap-4 text-sm font-bold">Total <span className="ml-auto">${calculateTotal().toFixed(2)}</span></li>
          </ul>
